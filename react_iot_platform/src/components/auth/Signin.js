...
class Signin extends Component {
  ...
  render() {
    ...
    return (
      <div className="row">
        <div className="signin container form-rounded col-sm-3 mt-4 pt-4">
            ...
            <div className="input-control">
              ...
              {this.props.autherr ? (
                <div className="text-danger error">
                  {this.props.autherr.response.data.email}
                </div>
              ) : null}
              <input
                className="form-control textbox "
              ...
              {this.props.autherr ? (
                <div className="text-danger error">
                  {this.props.autherr.response.data.password}
                </div>
              ) : null}
              {this.props.autherr ? (
                <div className="text-danger error mt-2" align="center">
                  {this.props.autherr.response.data.non_field_errors}
                </div>
              ) : null}
              ...
              <center>
                ...
                <button
                  type="submit"
                  className="btn btn-outline-success btn-block authbtn  mt-3 mb-4"
